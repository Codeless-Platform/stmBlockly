...
Blockly.Arduino.io_togglePin = function (a) {
  var b = a.getFieldValue('PIN'),
    c =
      Blockly.Arduino.valueToCode(a, 'STATE', Blockly.Arduino.ORDER_ATOMIC) ||
      'LOW';
...
Blockly.Arduino.io_builtin_led = function (a) {
  var b = a.getFieldValue('BUILT_IN_LED'),
    c =
      Blockly.Arduino.valueToCode(a, 'STATE', Blockly.Arduino.ORDER_ATOMIC) ||
      'LOW';
  Blockly.Arduino.reservePin(a, b, Blockly.bluepill.PinTypes.OUTPUT, 'Set LED');
  Blockly.Arduino.addSetup('io_' + b, 'pinMode(' + b + ', OUTPUT);', !1);
  return 'digitalWrite(' + b + ', ' + c + ');\n';
};
...
Blockly.Arduino.serial_print = function (a) {
  for (
    ...
    Blockly.Arduino.reservePin(
      a,
      e[f][1],
      Blockly.bluepill.PinTypes.SERIAL,
      'SERIAL ' + e[f][0]
    );
...
Blockly.Arduino.servo_write = function (a) {
  ...
  Blockly.Arduino.reservePin(
    a,
    b,
    Blockly.bluepill.PinTypes.SERVO,
    'Servo Write'
  );
...
Blockly.Arduino.stepper_config = function (a) {
  var b = Blockly.bluepill.PinTypes.STEPPER,
...
Blockly.Arduino.text_prompt_ext = function (a) {
  ...
  e
    ? d.push('int ' + Blockly.Arduino.DEF_FUNC_NAME + '(String msg) {')
