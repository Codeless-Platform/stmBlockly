...
Blockly.Msg.KEYPAD_TTL= "initalize 4x3 keypad connected to the selected port, where row pins are 0-3 and col pins 4-6";
...
Blockly.Msg.LCD_INIT_TTL= "initalize 16x2 LCD connected to selected port, where en: P2, rs:P3, data pins d4-d7: P4-P7";
...
Blockly.Msg.LCD_GOTO_TTL= "Sets LCD cursor to specified row and column, counting starts from 0";
